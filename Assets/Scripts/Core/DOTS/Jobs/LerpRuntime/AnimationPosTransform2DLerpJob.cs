...
namespace MNP.Core.DOTS.Jobs
{
    ...
    {
        [BurstCompile]
        public void Execute(DynamicBuffer<Transform2DPositionAnimationComponent> positionBuffer, in TransformPropertyInfoComponent transformInfoComponent, ref PosTransform2DPropertyComponent transformComponent, in PosTransform2DTimeComponent timeComponent, EnabledRefRO<PosTransform2DInterruptComponent> interruptComponent)
        {
