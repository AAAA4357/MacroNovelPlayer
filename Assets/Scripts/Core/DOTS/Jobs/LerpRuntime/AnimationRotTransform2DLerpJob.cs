...
namespace MNP.Core.DOTS.Jobs
{
    ...
    {
        [BurstCompile]
        public void Execute(DynamicBuffer<Transform2DRotationAnimationComponent> rotationBuffer, in TransformPropertyInfoComponent transformInfoComponent, ref RotTransform2DPropertyComponent transformComponent, in RotTransform2DTimeComponent timeComponent, EnabledRefRO<RotTransform2DInterruptComponent> interruptComponent)
        {
