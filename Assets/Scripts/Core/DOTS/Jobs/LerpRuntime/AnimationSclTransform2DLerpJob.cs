...
namespace MNP.Core.DOTS.Jobs
{
    ...
    {
        [BurstCompile]
        public void Execute(DynamicBuffer<Transform2DScaleAnimationComponent> scaleBuffer, in TransformPropertyInfoComponent transformInfoComponent, ref SclTransform2DPropertyComponent transformComponent, in SclTransform2DTimeComponent timeComponent, EnabledRefRO<SclTransform2DInterruptComponent> interruptComponent)
        {
